...
- `NEXT_PUBLIC_APP_URL=https://editup.vercel.app`
...
- `Site URL`: `https://editup.vercel.app`
- `Redirect URLs`:
  - `https://editup.vercel.app/dashboard/calculadora`
  - `https://editup.vercel.app`
...
- `https://editup.vercel.app/api/stripe/webhook`
...
4. Confirmar que `https://editup.vercel.app` abriu
...
- O projeto já está pronto para usar `editup.vercel.app` como URL principal via `NEXT_PUBLIC_APP_URL`.
