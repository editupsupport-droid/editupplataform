...
- `https://editupplataform.vercel.app`
...
Opcional, apenas se você quiser rodar manualmente a limpeza de links expirados:

- `CRON_SECRET`

Valor obrigatório para produção:

- `NEXT_PUBLIC_APP_URL=https://editupplataform.vercel.app`
- `GOOGLE_DRIVE_REDIRECT_URI=https://editupplataform.vercel.app/api/google-drive/callback`
...
Observação: o `vercel.json` foi removido para evitar bloqueio do deploy por cron job horário. A rota `/api/cron/approval-links` continua existindo, mas não é registrada automaticamente como Vercel Cron.
...
- `Site URL`: `https://editupplataform.vercel.app`
- `Redirect URLs`:
  - `https://editupplataform.vercel.app/dashboard/calculadora`
  - `https://editupplataform.vercel.app`
...
- `Authorized redirect URIs`
  ...
  - `https://editupplataform.vercel.app/api/google-drive/callback`
...
- `https://editupplataform.vercel.app/api/stripe/webhook`
...
4. Confirmar que `https://editupplataform.vercel.app` abriu
...
- O projeto já está pronto para usar `editupplataform.vercel.app` como URL principal via `NEXT_PUBLIC_APP_URL`.
